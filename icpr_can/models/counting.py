...
class MultiCountingDecoder(nn.Module):
    """ 多分支计数模型"""
    ...
    def forward(self,x,x_mask=None):
        counting_preds1, _ = self.counting_decoder1(x, x_mask)
        counting_preds2, _ = self.counting_decoder2(x, x_mask)
        counting_preds = (counting_preds1 + counting_preds2) / 2
        
        return counting_preds,counting_preds1,counting_preds2